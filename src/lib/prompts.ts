...
export const prompts: PromptDef[] = [
  {
    ...
    purpose:
      "Build a specific, local, behaviour-true picture of who actually buys — not a generic persona.",
    ...
    expected:
      "A one-page avatar: snapshot, jobs-to-be-done, search phrases (including near-me), WhatsApp-first behaviour, objections, and 5 message angles.",
    featured: true,
  },
  {
    id: "gap",
    ...
    expected:
      "A gap map, 3 claims to stop making, 3 claims to own, and a 90-day differentiation plan.",
    featured: true,
  },
  {
    id: "positioning",
...
export function buildPrompt(p: PromptDef) {
  return `ROLE
...
export function getFeatured() {
  return featuredIds
    ...
    .filter((p): p is PromptDef => Boolean(p));
}

export function promptsByCategory(id: PromptCategoryId) {
